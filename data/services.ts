...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: "Music",
    summary:
      "アカペラサークルでの経験を生かし、既存曲やオリジナル曲のフルコーラスアレンジ・楽譜制作を行います。",
    description: [
      "アカペラサークルでの活動経験を生かし、既存曲やオリジナル曲のアカペラアレンジ、楽譜制作を行います。",
  ...
  },
  {
    ...
    description: [
      "数学教育を学んできた経験や教材制作の経験を生かし、授業プリント、スライド、問題集、解説資料などの制作をサポートします。",
